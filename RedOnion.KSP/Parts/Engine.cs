...
namespace RedOnion.KSP.Parts
{
	...
	{
		[Unsafe, KspApi("class_multi_mode_engine.html", "Module of multi-mode engine, if present (null otherwise).")]
		public MultiModeEngine multiModule { get; protected set; }
		[Unsafe, KspApi("class_module_engines.html", "Module of first engine.")]
		public ModuleEngines firstModule { get; protected set; }
		[Unsafe, KspApi("class_module_engines.html", "Module of second engine, if present (null otherwise).")]
		...
		[Unsafe, KspApi("class_module_engines.html", "Active engine module.")]
		public ModuleEngines activeModule => firstIsActive ? firstModule : secondModule;
		[Unsafe, KspApi("class_module_gimbal.html", "Gimbal module, if present (null otherwise).")]
