...
/// <summary>
/// Aliases (alternative names) for the member
/// </summary>
[AttributeUsage(AttributeTargets.Property|AttributeTargets.Field|AttributeTargets.Method)]
...
public class KspApiAttribute : DescriptionAttribute
{
	// https://kerbalspaceprogram.com/api/ no longer works
	public static string BaseUrl = "https://anatid.github.io/XML-Documentation-for-the-KSP-API/";
	public string RelativePath { get; set; }
	public string ShortDesc { get; set; }
	public KspApiAttribute(string path) : base(Invariant($"[KSP API]({BaseUrl}/{path})"))
		=> RelativePath = path;
	public KspApiAttribute(string path, string desc) : base(Invariant($"[KSP API]({BaseUrl}/{path}): {desc}"))
	{
		RelativePath = path;
		ShortDesc = desc;
	}
