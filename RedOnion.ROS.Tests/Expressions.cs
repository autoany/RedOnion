...
global using RedOnion.ROS.Objects;
global using RedOnion.ROS.Parsing;
...
public class ROS_Expressions : CoreTests
{
	...
	public void ROS_Expr03_DivideAndNaN()
	{
		...
		Test(double.NaN,"0/.0");        // division by zero is NaN
		Test(7 % 3,		"7%3");         // integer modulo/reminder
		Test(7.5 % 2.5,	"7.5%2.5");     // double modulo/reminder
		Test(-7 % 3,	"-7%3");        // negative integer modulo/reminder
	}
